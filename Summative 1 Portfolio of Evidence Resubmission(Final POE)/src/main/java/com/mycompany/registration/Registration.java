...
public class Registration {
    ...
    private static final MessageDataManager dataManager = new MessageDataManager();
    ...
    public static void showQuickChatMenu(Scanner input){
        ...
        do{
            ...
            System.out.println("3) Data Management & System Reports");
        ...
        for(int i = 1; i <= num; i++){
            ...
            if(message.checkRecipientCell().contains("successfully")){
                ...
                if(action == 1){
                    ...
                    dataManager.addDisregarededMessage(message);
                    System.out.println("Press 0 to delete the message.");
                    int confirmDelete = input.nextInt(); input.nextLine();
                    if (confirmDelete == 0) {
                    ...
                    totalSentMessages++;
                    dataManager.addStoredMessage(message);
    ...
    private static void showDataManagementMenu(Scanner input) {
        ...
        do {
            ...
            subChoice = input.nextInt(); input.nextLine();
